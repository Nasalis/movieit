...
export function ContentCard() {
  ...
  return (
    ...
    >
      ...
      <footer className="grid grid-cols-2 gap-y-2 grid-rows-2 items-center p-2 bg-blue-100">
        <span className="col-start-1 col-end-3 row-start-1 row-end-1 text-white text-base font-bold">
          The Mandalorian
        </span>
        <small className="col-start-1 col-end-3 row-start-2 row-end-2 text-gray-200 text-xs">
